...
<head>
	<title>My First PHP page with Bootstrap</title>
	...
	<main role = "main">
		...
		<div class = "row">
			<div class = "col">
				...
				<br/>
				<hr/>
				<a href="lecture5_PHP_Learning_Spring2024.php" class = "btn btn-success btn-sm">Click here to Go to PHP Learning Page</a>
